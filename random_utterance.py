...
class RandomUtterance:
    ...
    def msg(self):
        ...
        return "".join(['STX',self.robot_hor_direction,robot_speed,self.robot_head_direction,'020','11',ver_speed, self.robot_face,'ETX'])
    ...
    def run(self):
        if self.flag == 0:
            ...
            if time.time() - self.move_time > 5:
                self.robot_hor_direction = random.choice(['10', '01', '11', '11', '11'])
                if self.robot_hor_direction == '11':
                    self.robot_head_direction = random.choice(['10', '01', '11', '11'])
